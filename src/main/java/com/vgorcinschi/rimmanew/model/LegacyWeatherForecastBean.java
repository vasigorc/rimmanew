 ...
 *
 * @author vgorcinschi
 * this class has been replaced with the ForecastBean
 * and is only preserved to not break the integration tests
 */
@ManagedBean
@Dependent
public class LegacyWeatherForecastBean implements Serializable, VGObserver{
     ...
     */
    public LegacyWeatherForecastBean() {
